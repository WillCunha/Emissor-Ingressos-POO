...
foreach ($obIngressos as $ingresso) {
    $dados .= '<div class="col-lg-auto">
                <label for="valorIngresso"><h5><b>' . $ingresso->titulo . ':</b></h5></label>
                ...
                <input type="text" name="dataIngresso[]" id="dataIngresso" placeholder="Defina uma data limite para venda deste ingresso." class="form-control col-sm-2" >
                <label for="dataIngresso">Quantidade máxima: </label>
                <input type="text" name="quantidadeIngresso[]" id="quantidadeIngresso" placeholder="Informe a quantidade de ingressos." class="form-control col-sm-2" >
                <input type="text" name="idIngresso[]" id="idIngresso" value="' . $ingresso->id . '" class="form-control" hidden>
                <input type="text" name="nomeIngresso[]" id="nomeIngresso" value="' . $ingresso->titulo . '" class="form-control" hidden>
        </div></br>';
}
